...
///
/// <para>Les six familles sont branchées. Une famille dont la source manque rend une
/// liste vide — elle ne casse jamais la composition.</para>
/// </summary>
public static class Tiroir
{
    ...
    [
        ...
        .. FaitsDeLaVille.Produire(contexte),
